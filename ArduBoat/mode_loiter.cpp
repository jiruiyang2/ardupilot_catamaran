...
void ModeLoiter::update()
{
    ...
    _distance_to_destination = boat.current_loc.get_distance(_destination);
    ...
    if (_distance_to_destination <= loiter_radius) {
        ...
        _desired_speed = attitude_control.get_desired_speed_accel_limited(desired_speed_within_radius, boat.G_Dt);
        ...
        _desired_yaw_cd = boat.current_loc.get_bearing_to(_destination);
