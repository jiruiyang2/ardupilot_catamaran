...
/*
  Boat parameter definitions
*/

const AP_Param::Info Boat::var_info[] = {
    ...
    // @Description: X acceleration in meters/second/second to use to trigger the motor start in auto mode. If set to zero then auto throttle starts immediately when the mode switch happens, otherwise the boat waits for the X acceleration to go above this value before it will start the motor
    // @Units: m/s/s
    // @Range: 0 20
    // @Increment: 0.1
    // @User: Standard
    ...
    // @Description: The base throttle percentage to use in auto mode. The CRUISE_SPEED parameter controls the target speed, but the boat starts with the CRUISE_THROTTLE setting as the initial estimate for how much throttle is needed to achieve that speed. It then adjusts the throttle based on how fast the boat is actually going.
    // @Units: %
    // @Range: 0 100
    // @Increment: 1
    // @User: Standard
    ...
    // @Description: Enable ground control station telemetry failsafe. When enabled the Boat will execute the FS_ACTION when it fails to receive MAVLink heartbeat packets for FS_TIMEOUT seconds.
    // @Values: 0:Disabled,1:Enabled,2:Enabled Continue with Mission in Auto
    // @User: Standard
    ...
    // @Description: What to do on a crash event. When enabled the boat will go to hold if a crash is detected.
...
const AP_Param::GroupInfo ParametersG2::var_info[] = {
    ...
    // @Values: 0:Undefined,1:Boat,2:Boat,3:BalanceBot
    // @User: Standard
...
// can get them.  These lines can be removed once Boat-3.6-beta testing begins or we improve the source of descriptions for GCSs.
//
// @Param: CH7_OPTION
...
// @Description: Navigation angle threshold in degrees to switch to pivot steering. This allows you to setup a skid steering boat to turn on the spot in auto mode when the angle it needs to turn it greater than this angle. An angle of zero means to disable pivot turning. Note that you will probably also want to set a low value for WP_RADIUS to get neat turns.
// @Units: deg
// @Range: 0 360
// @Increment: 1
// @User: Standard
...
void Boat::load_parameters(void)
{
    ...
    // convert CH7_OPTION to RC7_OPTION for Boat-3.4 to 3.5 upgrade
    ...
    // attitude control FF and FILT parameter changes for Boat-3.6
...
// PARAMETER_CONVERSION - Added: Mar-2022
...
#endif
#if AP_STATS_ENABLED
    // PARAMETER_CONVERSION - Added: Jan-2024 for Boat-4.6
    ...
    // PARAMETER_CONVERSION - Added: Feb-2024 for Boat-4.6
