...
void Boat::Log_Write_Depth()
{
    // only log depth on boats
    if (!boat.is_boat() || !rangefinder.has_orientation(ROTATION_PITCH_270)) {
        return;
    }
...
void Boat::Log_Write_GuidedTarget(uint8_t target_type, const Vector3f& pos_target, const Vector3f& vel_target)
{
...
void Boat::Log_Write_Nav_Tuning()
{
...
void Boat::Log_Write_Vehicle_Startup_Messages()
{
...
const LogStructure Boat::log_structure[] = {
...
// @URL: http://ardupilot.org/boat/docs/navigation.html
// @Field: TimeUS: Time since system startup
...
uint8_t Boat::get_num_log_structures() const
{
