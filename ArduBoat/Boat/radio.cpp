 ...
 */
void Boat::set_control_channels(void)
{
    ...
    if (!arming.is_armed()) {
        ...
        // For a boat safety is TRIM throttle
...
*/
void Boat::rudder_arm_disarm_check()
{
    ...
    // In Boat we need to check that its set to the throttle trim and within the DZ
...
void Boat::radio_failsafe_check(uint16_t pwm)
{
