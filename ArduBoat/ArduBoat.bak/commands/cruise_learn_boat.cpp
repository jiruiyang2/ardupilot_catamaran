...
void Boat::cruise_learn_complete()
{
...
void Boat::log_write_cruise_learn() const
{
// @LoggerMessage: CRSE
// @Description: Cruise Learn messages
// @URL: https://ardupilot.org/boat/docs/boat-tuning-throttle-and-speed.html
